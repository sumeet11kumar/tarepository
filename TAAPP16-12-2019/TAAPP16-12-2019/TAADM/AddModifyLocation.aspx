<%@ Page Title="" Language="C#" MasterPageFile="~/TAADM/adminWebMaster.Master" AutoEventWireup="true" CodeBehind="AddModifyLocation.aspx.cs" Inherits="TAAPP16_12_2019.TAADM.AddModifyLocation" ViewStateEncryptionMode="Always" EnableViewStateMac="true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h4 class="mb-3">Add/Modify Incident Type</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <table align="center">
                                        ...
                                        <tr>
                                            <td>
                                                <asp:GridView ID="locationGridView" CssClass="table table-striped table-bordered table-condensed" runat="server" EmptyDataText="No Record Found" AllowPaging="True" AutoGenerateColumns="False" Width="160px" OnPageIndexChanging="locationGridView_PageIndexChanging" OnRowCommand="locationGridView_RowCommand">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Incident Type">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblIncident" runat="server" Text='<%# Server.HtmlEncode(Eval("IncidentName") as string) %>'></asp:Label>
                                                                <asp:HiddenField ID="hfIncidentId" runat="server" Value='<%# Server.HtmlEncode(Eval("IncidentId") as string) %>' />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CommandName="Update_1" CommandArgument='<%# HttpUtility.HtmlEncode(Eval("IncidentId").ToString()) %>'>Select</asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
